...
用法: python run_single_symbol_batch.py SYMBOL
例如: python run_single_symbol_batch.py ETHUSD
"""
...
def main():
    if len(sys.argv) < 2:
        print("用法: python run_single_symbol_batch.py SYMBOL")
        print("例如: python run_single_symbol_batch.py ETHUSD")
        sys.exit(1)
    
    symbol = sys.argv[1].upper()
    
    print("="*80)
    print(f"{symbol} 分批分析脚本")
    print("="*80)
