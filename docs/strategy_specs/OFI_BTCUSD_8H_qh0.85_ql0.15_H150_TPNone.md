# OFI_BTCUSD_8H_qh0.85_ql0.15_H150_TPNone
...
|-------------|------------|
| Trailing Stop | 88.6% |
| Max Holding (Hmax) | 10.2% |

### Performance Comparison

| Cost Scenario | Mean R (Net) | Sharpe Ratio |
|---------------|--------------|--------------|
| Low Cost (0.0030%) | 2.938 | 0.214 |
| High Cost (0.0700%) | 2.880 | 0.210 |
