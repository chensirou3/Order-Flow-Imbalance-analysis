# OFI_ETHUSD_1D_qh0.80_ql0.20_H150_TPNone
...
**Key Characteristics**:
- Entry mode: **TREND**
- Signal thresholds: OFI_z >= 0.80 (long) or <= 0.80 (short)
- Maximum holding period: **150 bars**
- Take profit: **None** (trailing exit only)
- Historical trades: **107**
...
- |OFI_z| >= 0.80 quantile: Strong signal
...
**Long Entry**:
- OFI_z >= 0.80 quantile (strong buying pressure)
- Direction: LONG (follow the order flow)

**Short Entry**:
- OFI_z <= 0.20 quantile (strong selling pressure)
...
|---------------|--------------|--------------|
| Low Cost (0.0030%) | 1.207 | 0.136 |
| High Cost (0.0700%) | 1.180 | 0.133 |
