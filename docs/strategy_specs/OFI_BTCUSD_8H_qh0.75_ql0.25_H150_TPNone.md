# OFI_BTCUSD_8H_qh0.75_ql0.25_H150_TPNone
...
**Key Characteristics**:
- Entry mode: **TREND**
- Signal thresholds: OFI_z >= 0.75 (long) or <= 0.75 (short)
- Maximum holding period: **150 bars**
- Take profit: **None** (trailing exit only)
- Historical trades: **119**
...
- |OFI_z| >= 0.75 quantile: Strong signal
...
**Long Entry**:
- OFI_z >= 0.75 quantile (strong buying pressure)
- Direction: LONG (follow the order flow)

**Short Entry**:
- OFI_z <= 0.25 quantile (strong selling pressure)
...
|-------------|------------|
| Trailing Stop | 90.8% |
| Max Holding (Hmax) | 8.4% |

### Performance Comparison

| Cost Scenario | Mean R (Net) | Sharpe Ratio |
|---------------|--------------|--------------|
| Low Cost (0.0030%) | 2.180 | 0.180 |
| High Cost (0.0700%) | 2.117 | 0.175 |
